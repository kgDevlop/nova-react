...
const _button    = (actionId, Icon, label)        => ({ type: "button",    actionId, Icon, label });
const _separator = ()                              => ({ type: "separator"                         });
const _dropdown  = (actionId, label, options)      => ({ type: "dropdown",  actionId, label, options });
const _spacer    = ()                              => ({ type: "spacer"                            });

const TOOLBARS = {
  writer: [
    _dropdown("paragraphStyle", "Para", [
    ...
    _separator(),
    _button("bold",         I.Bold,        "Bold"),
    _button("italic",       I.Italic,      "Italic"),
    _button("underline",    I.Underline,   "Underline"),
    _separator(),
    _button("alignLeft",    I.AlignLeft,   "Left"),
    _button("alignCenter",  I.AlignCenter, "Center"),
    _button("alignRight",   I.AlignRight,  "Right"),
    _separator(),
    _button("bulletList",   I.ListUl,      "Bullet list"),
    _button("numberedList", I.List,        "Numbered list"),
    _button("blockquote",   I.Quote,       "Block quote"),
    _separator(),
    _button("insertLink",   I.Link2,       "Link"),
    _button("insertImage",  I.ImageIcon,   "Image"),
    _button("insertTable",  I.Table,       "Table"),
    _spacer(),
    _button("toggleFullscreen", I.Maximize, "Full screen"),
  ],
  spreads: [
    _dropdown("fontFamily", "Font", [
    ...
    _button("italic",          I.Italic,      "Italic"),
    _separator(),
    _button("formatCurrency",  I.Dollar,      "Currency"),
    _button("formatPercent",   I.Percent,     "Percent"),
    _separator(),
    _button("alignLeft",       I.AlignLeft,   "Left"),
    _button("alignCenter",     I.AlignCenter, "Center"),
    _button("alignRight",      I.AlignRight,  "Right"),
    _separator(),
    _button("toggleBorders",   I.BorderAll,   "Borders"),
    _spacer(),
    _button("toggleFilter",    I.Filter,      "Filter"),
    _button("toggleSort",      I.SortAsc,     "Sort"),
  ],
  slides: [
    _dropdown("slideLayout", "Layout", [
    ...
    _separator(),
    _button("addText",         I.TypeT,   "Add text"),
    _button("addRectangle",    I.Square,  "Add shape"),
    _button("addEllipse",      I.Globe,   "Add ellipse"),
    _separator(),
    _dropdown("slideTheme", "Theme", [
    ...
    _separator(),
    _button("duplicateSlide",   I.Copy,  "Duplicate slide"),
    _button("deleteSelection",  I.Trash, "Delete element"),
    _spacer(),
    _button("startPresentation", I.Play, "Present"),
  ],
  draw: [
    _button("selectTool",       I.ArrowR,  "Select (V)"),
    _separator(),
    _button("rectangleTool",    I.Square,  "Rect (R)"),
    _button("ellipseTool",      I.Globe,   "Ellipse (E)"),
    _button("lineTool",         I.ArrowR,  "Line (L)"),
    _button("textTool",         I.TypeT,   "Text (T)"),
    _button("penTool",          I.PenTool, "Pen (P)"),
    _separator(),
    _button("deleteSelection",  I.Trash,   "Delete"),
    _spacer(),
    _button("exportSvg",        I.Upload,  "Export SVG"),
  ],
  list: [],
};
...
export const DrawConstants = {
  ...
  DRAW_TOOLS: [
    { toolId: "selectTool",    label: "Select",  Icon: I.ArrowR,  key: "V" },
    { toolId: "rectangleTool", label: "Rect",    Icon: I.Square,  key: "R" },
    { toolId: "ellipseTool",   label: "Ellipse", Icon: I.Globe,   key: "E" },
    { toolId: "lineTool",      label: "Line",    Icon: I.ArrowR,  key: "L" },
    { toolId: "textTool",      label: "Text",    Icon: I.TypeT,   key: "T" },
    { toolId: "penTool",       label: "Pen",     Icon: I.PenTool, key: "P" },
  ],
  CURSOR_BY_TOOL: {
    selectTool:    "default",
    rectangleTool: "crosshair",
    ellipseTool:   "crosshair",
    lineTool:      "crosshair",
    textTool:      "text",
    penTool:       "crosshair",
  },
